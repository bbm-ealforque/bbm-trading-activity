...
from app.middlewares.MT4APIAuthenticationMiddleware import MT4APIAuthenticationMiddleware
from app.middlewares.MT5APIAuthenticationMiddleware import MT5APIAuthenticationMiddleware
...
class Kernel:
    ...
    route_middleware = {
        ...
        "auth.api.mt4": [MT4APIAuthenticationMiddleware],
        "auth.api.mt5": [MT5APIAuthenticationMiddleware],
    }
    ...
    def register_configurations(self):
        ...
        self.application.bind("repositories.location", "app/repositories")
        self.application.bind("services.location", "app/services")
